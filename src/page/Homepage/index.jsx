            ...
            <div className="container w-100 h-100">
                <div className="row p-5">
                    <div className="col-12 col-lg-6 crypto-boyz-homepage__banner__title__wrapper">
                        <p className="h1 font-weight-bold">Discover, collect, and sell extraordinary NFTs</p>
                        <p className="crypto-boyz-homepage__banner__title">Cryptoboyz is the world's first and largest NFT marketplace</p>
                        <div className="crypto-boyz-homepage__banner__title__submit__wrapper">
                            <button className="mr-4 crypto-boyz-homepage__banner__title__submit__button crypto-boyz-homepage__banner__title__submit__button--explore">Explore</button>
                            <button className="crypto-boyz-homepage__banner__title__submit__button crypto-boyz-homepage__banner__title__submit__button--create">Create</button>
                        </div>
                        <div className="crypto-boyz-homepage__banner__learn-more__wrapper">
                            <a className="crypto-boyz-homepage__banner__learn-more__link">Learn more about OpenSea</a>
                        </div>
                    </div>
                        ...
                        <article className="crypto-boyz-homepage__banner__thumb">
                            <a className="crypto-boyz-homepage__banner__thumb__link">
                                ...
                                <footer className="crypto-boyz-homepage__banner__thumb__footer row ml-0 mr-0">
                                    ...
                                    <div>
                                        <p className="crypto-boyz-homepage__banner__thumb__footer--title">An Ugly Dance with the Sky</p>
                                        <p className="crypto-boyz-homepage__banner__thumb__footer--link">Kacii_Eleven_and_the_Toy_Wors</p>
                                    </div>
